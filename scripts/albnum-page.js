...
const generateImage = function () {
  ...
  let reference = document.getElementById('containerino')
...
const start = function () {
  ...
  // imposta il colore ricorrente come sfondo del body
  document.body.style.backgroundColor = `#${mostRecurrentHex}`

  // console.log del risultato
  console.log(`Colore principale: #${mostRecurrentHex}`)
}
